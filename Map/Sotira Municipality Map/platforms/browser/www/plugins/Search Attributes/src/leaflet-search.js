...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		zoom: 20,						//default zoom level for move to location
		...
		textErr: 'Αδυναμία Εντοπισμού τοποθεσίας',	//error message
		textCancel: 'Ακύρωση',		    //title in cancel button		
		textPlaceholder: 'Αναζήτηση τοποθεσίας...',   //placeholder value			
